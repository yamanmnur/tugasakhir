          ...
          <div class="card-body">
            <form action="{{ route('tambah.pesan') }}" method="POST" >
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group focused">
                      ...
                      <input type="text" id="input-username" name="judul" class="form-control form-control-alternative" placeholder="Username" value="">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label class="form-control-label" for="input-email">tujuan</label>
                      <input type="text" name="tujuan" id="input-email" class="form-control form-control-alternative" value="{{ Session::get('kode_ekskul') }}">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group focused">
                      <label class="form-control-label" for="input-first-name">pengirim</label>
                      <input type="text" id="input-first-name" class="form-control form-control-alternative" placeholder="First name" name="pengirim" value="ketua">
                    </div>
              ...
              <div class="pl-lg-4">
                <div class="form-group focused">
                  <label>Pesan</label>
                  <textarea name="pesan" rows="4" class="form-control form-control-alternative" placeholder="A few words about you ..."></textarea>
                </div>
              </div>
              <div class="form-group focused">
